...
\begin{figure}[htbp]
\centering
\IfFileExists{assets/fig-ch04-04.png}{\includegraphics[width=0.96\linewidth]{assets/fig-ch04-04.png}}{\fbox{\parbox[c][48mm][c]{0.9\linewidth}{\centering 画像生成待ち\\ライフサイクル別の構築位置を比較する図}}}
