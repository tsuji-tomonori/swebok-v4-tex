# 3.6. ソフトウェア設計品質分析と評価 (Software Design Quality Analysis and Evaluation)

- 日本語: ソフトウェア設計品質分析と評価
- English: Software Design Quality Analysis and Evaluation

## 下位構成

- [3.6.1 設計レビューと監査 (Design Reviews and Audits)](./3.6.1.設計レビューと監査(Design_Reviews_and_Audits)/)
- [3.6.2 品質属性 (Quality Attributes)](./3.6.2.品質属性(Quality_Attributes)/)
