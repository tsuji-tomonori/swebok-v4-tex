...
\begin{figure}[htbp]
\centering
\IfFileExists{assets/fig-ch06-02.png}{\includegraphics[width=0.96\linewidth]{assets/fig-ch06-02.png}}{\fbox{\parbox[c][48mm][c]{0.9\linewidth}{\centering 画像生成待ち\\運用プロセスの三層図}}}
\caption{運用プロセスの三層図}
\label{fig:ch06-02}
\end{figure}
