...
\begin{figure}[htbp]
\centering
\IfFileExists{swebok_structure/CH02.ソフトウェアアーキテクチャ(Software_Architecture)/2.2.ソフトウェアアーキテクチャ記述(Software_Architecture_Description)/2.2.4.重要な意思決定としてのアーキテクチャ(Architecture_as_Significant_Decisions)/assets/fig-ch02-06.png}{\includegraphics[width=0.96\linewidth]{swebok_structure/CH02.ソフトウェアアーキテクチャ(Software_Architecture)/2.2.ソフトウェアアーキテクチャ記述(Software_Architecture_Description)/2.2.4.重要な意思決定としてのアーキテクチャ(Architecture_as_Significant_Decisions)/assets/fig-ch02-06.png}}{\fbox{\parbox[c][48mm][c]{0.9\linewidth}{\centering 画像生成待ち\\アーキテクチャ意思決定記録のテンプレート図}}}
