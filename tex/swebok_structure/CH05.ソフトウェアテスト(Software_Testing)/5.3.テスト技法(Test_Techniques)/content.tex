...
\begin{figure}[htbp]
\centering
\IfFileExists{assets/fig-ch05-06.png}{\includegraphics[width=0.96\linewidth]{assets/fig-ch05-06.png}}{\fbox{\parbox[c][48mm][c]{0.9\linewidth}{\centering 画像生成待ち\\主要テスト技法の比較図}}}
\caption{主要テスト技法の比較図}
\label{fig:ch05-06}
\end{figure}
